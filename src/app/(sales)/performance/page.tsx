...
import { TableFrame, TD, TH } from "@/components/table-ui";
    ...
    <main className={PAGE_MAIN}>
      <div className={PAGE_INNER}>
        <PageHeader
          eyebrow="Performance"
          title="成績"
          description="営業マンごとの実績。アポ獲得管理のデータから毎回計算しています"
          action={
            <button
              onClick={() => void load()}
        ...
        <section className="space-y-3">
          ...
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            {perf.owners.map((owner) => {
              ...
              return (
                <div key={owner} className={`${PANEL} flex flex-col`}>
