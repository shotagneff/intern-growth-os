  ...
  return (
    <main className={PAGE_MAIN}>
      <div className={PAGE_INNER}>
        <PageHeader
          eyebrow="Partner Map"
          title="パートナー紹介マインドマップ"
          description="管理画面で登録した「誰が誰を紹介したか」の情報を元に、紹介関係を一望できるようにした関係図です。"
          icon={
            <Image
              src="/images/icons/mindmap-icon.png"
        ...
        {/* マインドマップ描画キャンバス */}
        <Panel className="px-4 py-6 text-sm">
        ...
        <SectionCard title="この画面のイメージ">
          <div className="space-y-1 text-[11px] text-neutral-600 dark:text-neutral-300">
            <p>
              ・中央に MITSUKETA シークアドチームを置き、その周りに「直接提携しているパートナー」を同心円状に配置しています。
            </p>
            <p>
